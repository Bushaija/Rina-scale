...
import { 
  ...
  planSchema,
} from '@/features/planning/schema/malaria/plan-form-schema';
import { MALARIA_ACTIVITIES } from '../../constants/malaria/malaria-activities';
...
export function usePlanForm({ 
  ...
  const activityCategories = MALARIA_ACTIVITIES;
